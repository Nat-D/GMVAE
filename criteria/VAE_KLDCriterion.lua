...
--[[ Taken from https://github.com/y0ast/VAE-Torch/blob/master/GaussianCriterion.lua]]--
function VAE_KLDCriterion:updateOutput(mean, log_var)
...
function VAE_KLDCriterion:updateGradInput(mean, log_var)
	self.gradInput = {}
